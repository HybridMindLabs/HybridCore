...
Route::post('/database', [InstallerController::class, 'storeDatabase'])->name('installer.database.store')->middleware('throttle:10,1,installer-database');
...
Route::post('/account', [InstallerController::class, 'storeAdminAccount'])->name('installer.admin.store')->middleware('throttle:10,1,installer-account');
Route::get('/settings', [InstallerController::class, 'settings'])->name('installer.settings');
Route::post('/settings', [InstallerController::class, 'storeSettings'])->name('installer.settings.store')->middleware('throttle:10,1,installer-settings');
Route::get('/finish', [InstallerController::class, 'finish'])->name('installer.finish');
Route::post('/finish', [InstallerController::class, 'complete'])->name('installer.finish.complete')->middleware('throttle:10,1,installer-finish');
