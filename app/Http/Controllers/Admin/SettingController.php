...
class SettingController extends Controller
{
    ...
    public function index(): Response
    {
        return Inertia::render('Admin/Settings/Index', [
            'settings' => [
                ...
                'require_2fa_for_admins' => $this->settings->get('security.require_2fa_for_admins', '1') === '1',
                'require_2fa_grace_days' => (int) ($this->settings->get('security.require_2fa_grace_days', '3') ?: 3),
    ...
    public function update(UpdateSettingsRequest $request): RedirectResponse
    {
        ...
        $this->settings->setMany([
            ...
            'security.require_2fa_for_admins' => ($data['require_2fa_for_admins'] ?? true) ? '1' : '0',
            'security.require_2fa_grace_days' => (string) ($data['require_2fa_grace_days'] ?? 3),
