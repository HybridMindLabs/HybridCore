...
/**
 * Collects PUBLIC (site header) navigation items from core and enabled
 * extensions. Rendered in the public layout's main nav, alongside the built-in
 * links (Home, Servers, …).
 *
 * Extensions register a link from their service provider's boot():
 *
 ...
 *   );
 */
class PublicNavigationRegistry
{
     ...
     * @param  string  $icon  Lucide icon name (e.g. "ThumbsUp")
     * @param  int  $sort  Sort order (lower first)
     * @param  string|null  $permission  Permission slug required to see the item; null = everyone
     */
     ...
     * (the shared prop layer), which has the request user in hand.
     *
