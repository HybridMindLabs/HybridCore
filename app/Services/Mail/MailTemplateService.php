...
class MailTemplateService
{
    ...
    public function defaultTemplates(): array
    {
        return [
            ...
            [
                'slug' => 'account_locked',
                'name' => 'Account Locked (Failed Logins)',
                'subject' => 'Your {{ app_name }} account was temporarily locked',
                'body_html' => $this->accountLockedTemplate(),
                'variables' => ['app_name', 'username', 'lockout_minutes'],
                'system' => true,
                'active' => true,
            ],
            [
...
HTML;
    ...
    private function accountLockedTemplate(): string
    {
        return <<<'HTML'
<!DOCTYPE html>
<html>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0f1a;padding:40px 0;">
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background:#111827;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:32px;">
        <h2 style="color:#f1f5f9;margin:0 0 16px;">Account temporarily locked</h2>
        <p style="color:#94a3b8;margin:0 0 8px;line-height:1.6;">Hello {{ username }},</p>
        <p style="color:#94a3b8;margin:0 0 24px;line-height:1.6;">Too many incorrect password attempts were made on your account. It has been locked for {{ lockout_minutes }} minutes as a precaution.</p>
        <p style="color:#94a3b8;margin:0 0 24px;line-height:1.6;">If this wasn't you, your password may be known to someone else — change it as soon as the lock lifts.</p>
      </td></tr>
    </table>
  </td></tr>
</table>
