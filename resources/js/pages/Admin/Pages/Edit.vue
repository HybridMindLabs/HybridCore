...
import { ChevronLeft, FileText, ExternalLink } from '@lucide/vue';
...
const form = useForm({
    ...
    format: props.page.format as 'markdown' | 'html',
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-2">
                <a
                    ...
                    :href="`/${page.slug}`"
                    target="_blank"
                    class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-zinc-500 hover:text-zinc-100 border border-zinc-800/70 hover:border-zinc-700 transition-colors"
                >
                    <ExternalLink :size="11" :stroke-width="1.75" /> View
                </a>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-4 gap-5">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="bg-[#111113] border border-zinc-800/70 rounded-xl p-5 flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label class="text-zinc-500 text-xs font-medium">Slug</label>
